...
router.post('/', auth_tokenVerifier,
  ...
  async (req, res) => { // async function used to save, process input data and create new document
    ...
    try {
      ...
      let new_profile = await Profile.findOneAndUpdate( //
  ...
  async (req, res) => {
    try {
      ...
      return res.status(200).json({
        msg: responseMessage,
        updated_profile: foundProfile // send updated Array of experience documents
...
router.delete('/education/:edu_id', auth_tokenVerifier,
  ...
  async (req, res) => {
    try {
      ...
      // UPDATE EDUCATION in profile by removing education document in the 
      // Array "foundProfile.experience" (which is an Array containing mutiple education document obj)
      ...
      return res.status(200).json({
        msg: responseMessage,
        updated_profile: foundProfile // send updated Array of education documents
      });
